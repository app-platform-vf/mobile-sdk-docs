...
- Mở mini app từ Adjust link / QR code
- Quản lý lifecycle
- Xử lý callback giữa host app và mini app (user data, payment, session expiry)
- Intercept JS bridge messages

## Bắt đầu

1. [Installation](installation.md) - Cài đặt SDK và khởi tạo `SdkConfig`
2. [Configuration](configuration.md) - Cấu hình `HostAppBridge` và `InitRequest`
