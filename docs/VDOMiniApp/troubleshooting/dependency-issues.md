...
configurations.all {
    resolutionStrategy {
        force 'com.example:network-sdk:2.3.1'
    }
}
```
...
**Triệu chứng:** Runtime error do version SDK không tương thích.

**Giải pháp:**
- Kiểm tra [Dependency Matrix](../dependency-matrix.md)
- Đảm bảo tất cả SDK đều dùng version tương thích
- Download package mới nhất từ [Release Notes](../releases/ios/2.1.0.md)
