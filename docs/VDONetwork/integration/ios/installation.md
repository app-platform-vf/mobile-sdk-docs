...
VDONetwork được phân phối như một phần của package **VDOFrameworks**. Xem hướng dẫn chi tiết tại [VDOMiniApp Installation](../../../VDOMiniApp/integration/ios/installation.md).

Trong `Package.swift`, VDONetwork là một binary target:
